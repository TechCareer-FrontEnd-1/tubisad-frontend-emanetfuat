...
let secretFunction = () => {
var val = prompt("Bir kelime giriniz");
var sonuc = "";
for (let i = 1; i < val.length-1; i++) {
  sonuc = sonuc + "*";
  
}
document.write(val[0]+sonuc+val[val.length-1]);
}
//secretFunction();
...
let denklem = () => {
    var x = Number(prompt("x'in değerini giriniz"));
    var k = Number(prompt("k'nın değerini giriniz"));
...
let celciusToFahrenheit = () => {
  var x = Number(prompt("Celcius değerini girin."));
  alert((x*9/5)+32);
...
let negativeOrPositive = () => {
  var val = Number(prompt("Sayıyı girin."));
  if (val < 0) {
      alert("Negatif");
    }else if(val > 0){
      alert("Pozitif");
...
//ÖDEV-4 Kullanıcı tarafından aldığımız password ile repassword girilsin 
//doğru ve yanlışı göstersin ?
let checkPassword = () => {
  var password = prompt("Parola giriniz");
  var rePassword = prompt("Tekrar giriniz");
...
// ÇÖZÜM
//var sayiBaslangic = Number(prompt("Başlangıç sayısını giriniz"));
//var sayiBitis = Number(prompt("Bitiş sayısını giriniz"));

let kacTaneSayiVar = () => {
  alert(sayiBitis-sayiBaslangic+1 +" sayı var");
}
//kacTaneSayiVar();
...
let sayilarToplami = () => {
  ...
  if(sayiBaslangic >= sayiBitis){
    alert("Bitiş başlangıçtan büyük olmalı");
  }else{
  for (var i = sayiBaslangic; i <= sayiBitis; i++) {
    toplam += i;
  }
...
let tekMiCiftMi = () => {
    ...
    var ciftSayilarToplami;
    kacTekSayi =0;
    var kacTekSayi;
    tekSayilarToplami =0;
    var tekSayilarToplami;
    ciftSayilar = "";
    var ciftSayilar;
    tekSayilar = "";
    var tekSayilar;
  ...
  for (let i = sayiBaslangic; i <= sayiBitis; i++) {
    if(i == 7){
      continue;
          ...
          if(sayiBaslangic == 44 || sayiBitis == 44){
            alert("Secret Key 44 ");
            break;
          }else {
                if (i % 2 == 0) {
                  kacCiftSayi++;
                  ciftSayilarToplami = ciftSayilarToplami + i;
                  ciftSayilar = ciftSayilar + String(i) + " ";
                  
                }
                else {
                  kacTekSayi++;
                  tekSayilarToplami += i;
                  tekSayilar = tekSayilar + String(i) + " ";
    ...
    document.write("<br>"+kacCiftSayi + " tane çift sayı var");
    document.write("<br>"+"Çift Sayılar: " + ciftSayilar);
    document.write("<br>"+"Çift Sayılar Toplamı: " + ciftSayilarToplami + "<hr>");
    document.write("<br>"+kacTekSayi + " tane tek sayı var");
    document.write("<br>"+"Tek Sayılar: " + tekSayilar);
    document.write("<br>"+"Tek Sayılar Toplamı: " + tekSayilarToplami);
...
let login = () => {
  ...
  while (count > 0) {
    ...
    if (userEmail === dbUserEmail && userPassword === dbUserPassword)
      ...
      count--;
      alert(`kalan hakkınız: ${count}`) //literal template yapısı
    }
  }
